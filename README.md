...
🛠 Tech Stack
Automation Engine: n8n (Self-hosted or Desktop)
...
🚀 Features
Multi-Platform Scraping: Filters leads by bio keywords, location, and follower/engagement ratios.
...
📈 Future Improvements (Budget/Time)
Lead Scoring: Implement a deeper "Bio Relevance" score using LLM analysis to filter high-ticket prospects only.
